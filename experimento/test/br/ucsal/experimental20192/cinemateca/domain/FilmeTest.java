...
*/
    ...
    */
    //11h04 - 11h15 (11min)
    @Test
    public void deveConsultarFilmePorGenero(){
        List<Filme> filmesEsperados = new ArrayList<>();

        Filme filme1 = new Filme();
        filme1.setTitulo("Filme1");
        filme1.setAnoLancamento(2010);
        filme1.setSinopse("SinFilme1");
        filme1.setGeneroFilme(GeneroFilmeEnum.ACAO);

        Filme filme2 = new Filme();
        filme2.setTitulo("Filme2");
        filme2.setAnoLancamento(2010);
        filme2.setSinopse("SinFilme2");
        filme2.setGeneroFilme(GeneroFilmeEnum.ACAO);

        filmesEsperados.add(filme1);
        filmesEsperados.add(filme2);
        //
        Filme[] retorno = filme1.consultarFilmePorGenero(GeneroFilmeEnum.ACAO);
        //
        Assert.assertEquals(filmesEsperados, retorno);
    }
